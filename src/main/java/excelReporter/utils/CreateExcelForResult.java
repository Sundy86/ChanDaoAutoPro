...
public class CreateExcelForResult{
	...
	public static void createExcelReport(List<XmlSuite> xml, List<ISuite> suites,String dir) {
		...
		String excelReportDirStr = "./result/excelReports/";
		...
		dir = excelReportDirStr+"TestReport_"+fileNameFormat.format(new Date())+"-"+suites.get(0).getName()+".xlsx";
